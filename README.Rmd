...
`scale_colour_dh()` is used in the example above. The code for `scale_*_dh()` provides examples for other who wish to create similar functions for other departments.
