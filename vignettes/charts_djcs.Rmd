...
`scale_fill_djcs` allows us to easily specify a palette comprised of departmental style guide compliant colours. We specify the `"navys"` palette in the example below.
...
last_plot() +
 ...
 # scale_fill_djcs(palette = "navys", name = NULL, reverse = TRUE) +
...
ggplot(
  ...
  scale_colour_djcs_line(name = NULL, colour = "cobalt") +
  theme_vps_djcs() 
```
...
ggplot2::ggplot(
  ...
  # na.value
  scale_fill_manual(guide = "none", values = c("M3" = bv.navy), na.value = bv.smoke)+
